...
public class ListPendingAssignmentsResponseFutureCallback extends AbstractFutureCallback<CounterAssignmentServiceOuterClass.ListSectorsResponse> {
    public ListPendingAssignmentsResponseFutureCallback(Logger logger, CountDownLatch latch) {
        super(logger, latch);
    }
